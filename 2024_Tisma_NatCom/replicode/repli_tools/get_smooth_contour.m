function [contourX,contourY]=get_smooth_contour(BWedge,pts);
...
%sort_contour
 ...
 contourX=XX(BWedge)+0.5;
 contourY=YY(BWedge)+0.5; 
[contourX,contourY]=sort_contour(contourX,contourY);    
    
%equalize and iterpolate   
[contourX,contourY]=EqualizeAlongContour(contourX,contourY,pts); 
