...
initval.codepth=swap_path('C:\Users\aleksandrejapa\Desktop\replicode\');
initval.mainexperimentpath=swap_path('O:\My Nguyen'); 
initval.processeddatapath=swap_path('O:\My Nguyen\');
