function [Ipol_Axis,Ipol_Curve,Ipol_NormCurve]=C025_Get_AnyPropertyVsMaxDistanceCurve(Chromosome,Aligned,PropertyCurve,initval);
    ...
    p1x=Chromosome.CartesianContourMax_X(Aligned.Ori.AllIndices);
    p1y=Chromosome.CartesianContourMax_Y(Aligned.Ori.AllIndices);
