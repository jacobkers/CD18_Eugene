...
%
%edits 2021_jacob kers
%chrnr2 is a pre-set chromosome number value, I use 1 for getting info on the phase image
pixpermu=12.5;
pixpermu=1;
...
if sum(Ibi4)==0;
    ...
    % now pick out the size/center/left/right of each cluster
    ...
    chrout=cat(2,(1:1:chrnr2)',chrout(:,2)./pixpermu/pixpermu,chrout(:,3:5)./pixpermu,(chrout(:,5)-chrout(:,4))./pixpermu,ones(chrnr2,1).*chrfound,chrout(:,6:7));
end
