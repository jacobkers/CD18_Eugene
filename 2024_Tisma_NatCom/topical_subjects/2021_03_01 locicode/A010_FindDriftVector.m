function A010_FindDriftVector(initval)
%JWJK_A:-------------------------------------------------------------------
...
load('driftmarkers.mat','rclick','cclick');
...
x0=cclick; y0=rclick;
    ...
    if initval.updateROI
        ...
        cd(initval.imagepath); 
        fullim=double(imread(strcat(initval.imagepath,FilNames(ii).name))); cd(pwd);
